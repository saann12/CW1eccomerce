...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    require_once "../include/db.php"; // Ensure this path is correct
                ...
                if ($stmt->num_rows == 1) {
                    ...
                    if ($stmt->fetch()) {
                        if (password_verify($password, $hashed_password)) {
                            ...
                            if ($privilege === 'admin') {
                                header("location: profile/admin_panel.php");
                            } else {
    ...
    <section class="form-page">
        <div class="formlog">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <hr>
                <div class="reglog">
                    <p>Don't have an account? <a class="alt-log" href="register.php">Register now!</a></p>
                </div>
            </form>
        </div>
    </section>
